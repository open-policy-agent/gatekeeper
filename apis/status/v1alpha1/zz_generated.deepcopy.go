...
func (in *ConnectionPodStatusList) DeepCopyInto(out *ConnectionPodStatusList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ConnectionPodStatus, len(*in))
		for i := range *in {
...
func (in *ConnectionPodStatusList) DeepCopy() *ConnectionPodStatusList {
	...
	out := new(ConnectionPodStatusList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ConnectionPodStatusStatus) DeepCopyInto(out *ConnectionPodStatusStatus) {
	*out = *in
	...
	if in.PublishStatuses != nil {
		in, out := &in.PublishStatuses, &out.PublishStatuses
		*out = make([]ConnectionPublishStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ConnectionPodStatusStatus) DeepCopy() *ConnectionPodStatusStatus {
	...
	out := new(ConnectionPodStatusStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConnectionPublishStatus) DeepCopyInto(out *ConnectionPublishStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionPublishStatus.
func (in *ConnectionPublishStatus) DeepCopy() *ConnectionPublishStatus {
	if in == nil {
		return nil
	}
	out := new(ConnectionPublishStatus)
	in.DeepCopyInto(out)
	return out
}
