...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KindName) DeepCopyInto(out *KindName) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KindName.
func (in *KindName) DeepCopy() *KindName {
	if in == nil {
		return nil
	}
	out := new(KindName)
