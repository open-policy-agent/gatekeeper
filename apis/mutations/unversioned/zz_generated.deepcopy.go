...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateExpansionStatus) DeepCopyInto(out *TemplateExpansionStatus) {
	*out = *in
	if in.ByPod != nil {
		in, out := &in.ByPod, &out.ByPod
		*out = make([]v1beta1.MutatorPodStatusStatus, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateExpansionStatus.
func (in *TemplateExpansionStatus) DeepCopy() *TemplateExpansionStatus {
	if in == nil {
		return nil
	}
	out := new(TemplateExpansionStatus)
	in.DeepCopyInto(out)
	return out
}
