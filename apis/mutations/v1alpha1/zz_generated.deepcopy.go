...
func (in *AssignMetadataSpec) DeepCopyInto(out *AssignMetadataSpec) {
	*out = *in
	...
	out.MetadataParameters = in.MetadataParameters
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PathTests) DeepCopyInto(out *PathTests) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PathTests.
func (in *PathTests) DeepCopy() *PathTests {
	if in == nil {
		return nil
	}
	out := new(PathTests)
