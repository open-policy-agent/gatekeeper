...
| preUninstall.deleteWebhooks.image.tag         | Image tag                                                                                                                                                                                                                                           | Current release version: `v3.7.0`                                         |
...
| validatingWebhookCustomRules                  | Custom rules for selecting which API resources trigger the webhook                                                                                                                                                                                  | `{}`                                                                      |
...
| mutatingWebhookCustomRules                    | Custom rules for selecting which API resources trigger the webhook                                                                                                                                                                                  | `{}`                                                                      |
