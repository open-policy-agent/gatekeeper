...
func Convert_v1alpha1_Target_To_templates_Target(in *Target, out *coreTemplates.Target, s conversion.Scope) error { // nolint:revive // Required exact function name.
	...
	for i := range in.Code {
		if err := Convert_v1alpha1_Code_To_templates_Code(&(in.Code[i]), &(out.Code[i]), s); err != nil {
			return err
		}
	}
...
func Convert_templates_Target_To_v1alpha1_Target(in *coreTemplates.Target, out *Target, s conversion.Scope) error { // nolint:revive // Required exact function name.
	// Call the auto-generated conversion function first
	if err := autoConvert_templates_Target_To_v1alpha1_Target(in, out, s); err != nil {
		return err
	}
