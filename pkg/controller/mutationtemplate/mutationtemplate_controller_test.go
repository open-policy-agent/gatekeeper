...
func TestReconcile(t *testing.T) {
	...
	instance := &templatesv1alpha1.MutationTemplate{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the MutationTemplate object and expect the Reconcile
