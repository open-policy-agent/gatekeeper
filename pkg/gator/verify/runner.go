...
type Runner struct {
	...
	newClient func(includeTrace bool, useK8sCEL bool, useLLM bool) (gator.Client, error)
...
func NewRunner(filesystem fs.FS, newClient func(includeTrace bool, useK8sCEL bool, useLLM bool) (gator.Client, error), opts ...RunnerOptions) (*Runner, error) {
	s := runtime.NewScheme()
...
func UseLLM(useLLM bool) RunnerOptions {
	return func(r *Runner) {
		r.useLLM = useLLM
	}
}
...
func (r *Runner) tryAddConstraint(ctx context.Context, suiteDir string, t *Test) error {
	client, err := r.newClient(r.includeTrace, r.useK8sCEL, r.useLLM)
	if err != nil {
