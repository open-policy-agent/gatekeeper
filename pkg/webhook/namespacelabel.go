...
// +kubebuilder:webhook:verbs=CREATE;UPDATE,path=/v1/admitlabel,mutating=false,failurePolicy=ignore,groups="",resources=namespaces,versions=*,name=check-ignore-label.gatekeeper.sh
