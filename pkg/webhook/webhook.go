...
var AddToManagerFuncs []func(manager.Manager, *client.Client, *match.Set) error
...
func AddToManager(m manager.Manager, opa *client.Client, processExcluder *match.Set) error {
