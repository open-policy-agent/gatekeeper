...
var AddToManagerFuncs []func(manager.Manager, *client.Client, *processexcluder.Set) error
...
func AddToManager(m manager.Manager, opa *client.Client, processExcluder *processexcluder.Set) error {
