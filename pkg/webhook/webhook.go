...
var AddToManagerFuncs []func(manager.Manager, *client.Client, *process.Excluder, *mutation.Cache) error
...
func AddToManager(m manager.Manager, opa *client.Client, processExcluder *process.Excluder, mutationCache *mutation.Cache) error {
