...
func (h *validationHandler) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	if h.skipExcludedNamespace(req.AdmissionRequest.Namespace) || (req.AdmissionRequest.Kind.Kind == "Namespace" && req.AdmissionRequest.Kind.Group == "" && h.skipExcludedNamespace(req.AdmissionRequest.Name)) {
