...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatchDummyCRD) DeepCopyInto(out *MatchDummyCRD) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatchDummyCRD.
func (in *MatchDummyCRD) DeepCopy() *MatchDummyCRD {
	if in == nil {
		return nil
	}
	out := new(MatchDummyCRD)
	in.DeepCopyInto(out)
	return out
}
