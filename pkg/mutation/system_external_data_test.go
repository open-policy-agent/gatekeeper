	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				sendRequestToExternalDataProvider: func(ctx context.Context, provider *externaldatav1beta1.Provider, keys []string, clientCert *tls.Certificate) (*externaldata.ProviderResponse, int, error) {
