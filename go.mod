...
replace github.com/open-policy-agent/frameworks/constraint => github.com/open-policy-agent/frameworks/constraint v0.0.0-20251028023458-2c97218bc2db
...
require (
	...
	github.com/open-policy-agent/frameworks/constraint v0.0.0-20251027174004-8e0ca170605e
