...
| postInstall.labelNamespace.image.tag          | Image tag                                                                                                                                                                                                                                           | Current release version: `v3.8.0`                                         |
...
| preUninstall.deleteWebhooks.image.tag         | Image tag                                                                                                                                                                                                                                           | Current release version: `v3.8.0`                                         |
...
| image.release                                 | The image release tag to use                                                                                                                                                                                                                        | Current release version: `v3.8.0`                                         |
